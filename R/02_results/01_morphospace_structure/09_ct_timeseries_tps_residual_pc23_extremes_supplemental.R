...
#
#   - Uses coords_resid_CT3 from R/03_subset_CT_timeseries.R
...
if (!exists("coords_resid_CT3")) {
  stop("coords_resid_CT3 not found. Ensure R/03_subset_CT_timeseries.R builds it.")
}
if (!exists("coords_CT3")) {
  stop("coords_CT3 not found. Ensure R/03_subset_CT_timeseries.R builds it.")
}
if (!exists("gdf_CT3")) {
  stop("gdf_CT3 not found. Ensure R/03_subset_CT_timeseries.R builds it.")
}
