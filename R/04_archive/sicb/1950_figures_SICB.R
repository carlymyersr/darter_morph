...
if (!exists("coords_1950"))       stop("coords_1950 not found. Ensure R/02_subset_1950.R builds it.")
if (!exists("coords_resid_1950")) stop("coords_resid_1950 not found. Ensure R/02_subset_1950.R builds it.")
if (!exists("gdf_1950"))          stop("gdf_1950 not found. Ensure R/02_subset_1950.R builds it.")
if (!exists("make_hulls"))        stop("make_hulls() not found. Keep it in R/00_setup_morpho.R.")
if (!exists("ref_1950"))          stop("ref_1950 not found. It should be created in R/02_subset_1950.R.")
if (!exists("links_1950"))        stop("links_1950 not found. It should be created in R/02_subset_1950.R.")
