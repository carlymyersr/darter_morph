...
#   R/methods/02_landmark_acquisition_geometric_morphometrics/00_setup_morpho.R           (coords_gpa, links_all, helpers)
#   R/methods/01_specimen_sampling_study_design/01_build_metadata.R         (gdf, allometry_residuals, etc.)
#   R/methods/01_specimen_sampling_study_design/03_subset_CT_timeseries.R   (gdf_CT3, coords_CT3, coords_resid_CT3)
#
...
# ============================================================
if (!exists("coords_CT3"))       stop("coords_CT3 not found. Ensure R/methods/01_specimen_sampling_study_design/03_subset_CT_timeseries.R builds it.")
if (!exists("coords_resid_CT3")) stop("coords_resid_CT3 not found. Ensure R/methods/01_specimen_sampling_study_design/03_subset_CT_timeseries.R builds it.")
if (!exists("gdf_CT3"))          stop("gdf_CT3 not found. Ensure R/methods/01_specimen_sampling_study_design/03_subset_CT_timeseries.R builds it.")
if (!exists("links_all"))        stop("links_all not found. It should be created in R/methods/02_landmark_acquisition_geometric_morphometrics/00_setup_morpho.R")
