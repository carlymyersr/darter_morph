...
if (!exists("coords_resid_Fig6")) {
  stop("coords_resid_Fig6 not found. Ensure R/methods/01_specimen_sampling_study_design/04_subset_CT_timeseries_plus_1950habitats.R builds it.")
}

if (!exists("gdf_Fig6")) {
  stop("gdf_Fig6 not found. Ensure R/methods/01_specimen_sampling_study_design/04_subset_CT_timeseries_plus_1950habitats.R builds it.")
}
...
if (exists("coords_Fig6")) {
  ...
  stop("Raw complete-landscape coordinates not found. Expected coords_Fig6 or coords_raw_Fig6 from R/methods/01_specimen_sampling_study_design/04_subset_CT_timeseries_plus_1950habitats.R.")
}
