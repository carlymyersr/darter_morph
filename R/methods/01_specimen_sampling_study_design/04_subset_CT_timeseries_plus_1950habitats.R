...
#   allometry_residuals() from R/methods/01_specimen_sampling_study_design/01_build_metadata.R
# ============================================================
...
cat("\nObjects created by R/methods/01_specimen_sampling_study_design/04_subset_CT_timeseries_plus_1950habitats.R:\n")
