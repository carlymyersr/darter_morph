...
#
# Requires (from R/methods/02_landmark_acquisition_geometric_morphometrics/00_setup_morpho.R):
#   coords_gpa, gpa
#
# Outputs:
...
if (!exists("gpa"))        stop("gpa not found. Run source('R/methods/02_landmark_acquisition_geometric_morphometrics/00_setup_morpho.R') first.")
...
if (VERBOSE) {
  cat("\nObjects created by R/methods/01_specimen_sampling_study_design/01_build_metadata.R:\n")
