...
if (!exists("gdf_1950"))         stop("gdf_1950 not found. Did R/methods/01_specimen_sampling_study_design/02_subset_1950.R run fully?")
...
cat("============================================================\n\n")
cat("Allometry correction applied upstream in R/methods/01_specimen_sampling_study_design/02_subset_1950.R\n")
