...
#
#   - Uses coords_resid_1950 from R/methods/01_specimen_sampling_study_design/02_subset_1950.R
...
if (!exists("coords_resid_1950")) {
  stop("coords_resid_1950 not found. Ensure R/methods/01_specimen_sampling_study_design/02_subset_1950.R builds it.")
}
